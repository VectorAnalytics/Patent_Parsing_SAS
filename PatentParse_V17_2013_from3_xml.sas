*Successfully parses 3 XML files dated 2012+ and outputs the utility patents to a single csv file and single perm sas table;
%GLOBAL cleanText;
%LET abText = ;
%INCLUDE "H:\Patent\Programs\RemoveTagsMacro.sas";
OPTIONS NoQuoteLenMax;
data patent_data_2;
	INFILE "C:\Users\mprice79\Documents\MP_Patents\Patent_xml\2013\2013_4_2cat_xml.xml" DSD DLM='0A'X LRECL=5000 TRUNCOVER;
	INPUT lineText   :$5000.;
...
data patent_data_3;
	INFILE "C:\Users\mprice79\Documents\MP_Patents\Patent_xml\2013\2013_4_3cat_xml.xml" DSD DLM='0A'X LRECL=5000 TRUNCOVER;
	INPUT lineText   :$5000.;
	FORMAT docSection $50. grant_num $7. grant_date $8. grant_type $2. main_uspc $8.
		cpc_m_section $8. cpc_m_class $8. cpc_m_subclass $8. cpc_m_main_group $8. cpc_m_subgroup $8.
		cpc_m_position $2. cpc_m_value $2.
...
data patent_data_4;
	INFILE "C:\Users\mprice79\Documents\MP_Patents\Patent_xml\2013\2013_4_4cat_xml.xml" DSD DLM='0A'X LRECL=5000 TRUNCOVER;
	INPUT lineText   :$5000.;
	FORMAT docSection $50. grant_num $7. grant_date $8. grant_type $2. main_uspc $8.
		cpc_m_section $8. cpc_m_class $8. cpc_m_subclass $8. cpc_m_main_group $8. cpc_m_subgroup $8.
		cpc_m_position $2. cpc_m_value $2.
...
*Retain values of variables for a patent until the end of the patent is reached;
	...
	Run;
OPTIONS QuoteLenMax;
data patent_data_all;
	set patent_data_2 patent_data_3  patent_data_4 ;
	run;

data patent_data_all;
	set patent_data_all (drop=lineText docSection tempText);
	run;
/*
%MACRO AddPatentsToBiggerDataset;
%IF %SYSFUNC(EXIST(patent_data_big)) %THEN %DO;
	DATA patent_data_big;
		SET patent_data_big patent_data;
	RUN;
%END;
%ELSE %DO;
	DATA patent_data_big;
	...
	RUN;
%END;
%MEND AddPatentsToBiggerDataset;
%AddPatentsToBiggerDataset */

Proc export data=patent_data_all
	outfile="C:\Users\mprice79\Documents\MP_Patents\Patent_CSV\Patent_data_2013.csv"
	dbms=csv
	replace;
	run;

DATA pats.Patent_data_2013;
	SET patent_data_all;
RUN;

*PatentParse_V12 successfully parses one XML file dated 2012+ and outputs the utility patents to a single csv file and single perm sas table;
%GLOBAL cleanText;
%LET abText = ;
%INCLUDE "H:\Patent\Programs\RemoveTagsMacro.sas";
OPTIONS NoQuoteLenMax;
data patent_data;
	INFILE "C:\Users\mprice79\Documents\MP_Patents\Patent_xml\2011cat_xml.xml" DSD DLM='0A'X LRECL=5000 TRUNCOVER;
	INPUT lineText  :$5000.;
...
OPTIONS QuoteLenMax;
data patent_data;
	set patent_data (drop=lineText docSection tempText);
	run;

/*Proc print data=patent_data;
	run; */
...
Proc export data=patent_data_big
	outfile="C:\Users\mprice79\Documents\MP_Patents\Patent_CSV\Patent_data_2011.csv"
	dbms=csv
	replace;
	run;

DATA pats.Patent_data_2011;
	SET patent_data_big;
RUN;
